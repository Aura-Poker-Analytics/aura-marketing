...
**Owner:** Rafael (aprova e publica tudo) · **Autor:** Fábrica de posts · **Início:** L = 10/07/2026
...
|---|---|---|---|---|---|---|
| P1 | 10/07 (D0) | 1 | L1 Reveal | Card + Story | `w1-hero` | [semana-1/w1-p1-hero.png](../instagram/output/programa-4-semanas/semana-1/w1-p1-hero.png) |
| P2 | 11/07 | 1 | L2 Module tour | Carrossel 5 | `meet-*` | [2026-07-10-carrossel-lancamento/](../instagram/output/2026-07-10-carrossel-lancamento/) |
| P3 | 13/07 | 1 | L4 Feature | Card | `w1-spot-hotspot` | [semana-1/w1-p3-spot-hotspot.png](../instagram/output/programa-4-semanas/semana-1/w1-p3-spot-hotspot.png) |
| P4 | 15/07 | 1 | L4 Feature | Card | `w1-spot-postflop` | [semana-1/w1-p4-spot-postflop.png](../instagram/output/programa-4-semanas/semana-1/w1-p4-spot-postflop.png) |
| P5 | 17/07 | 2 | L2 Module tour | Carrossel 4 | `w2-pre-*` | [semana-2/](../instagram/output/programa-4-semanas/semana-2/) |
| P6 | 20/07 | 2 | L3 Pergunta | Card | `w2-l3-defend` | [semana-2/w2-p6-l3-defend.png](../instagram/output/programa-4-semanas/semana-2/w2-p6-l3-defend.png) |
| P7 | 22/07 | 2 | L4 Feature/filtro | Card | `w2-spot-stage` | [semana-2/w2-p7-spot-stage.png](../instagram/output/programa-4-semanas/semana-2/w2-p7-spot-stage.png) |
| P8 | 24/07 | 3 | L2 Module tour | Carrossel 4 | `w3-post-*` | [semana-3/](../instagram/output/programa-4-semanas/semana-3/) |
| P9 | 27/07 | 3 | L3 Pergunta | Card | `w3-l3-rfi` | [semana-3/w3-p9-l3-rfi.png](../instagram/output/programa-4-semanas/semana-3/w3-p9-l3-rfi.png) |
| P10 | 29/07 | 3 | L5 CTA | Card | `meet-cta` | [semana-3/w3-p10-cta.png](../instagram/output/programa-4-semanas/semana-3/w3-p10-cta.png) |
| P11 | 31/07 | 4 | L2 How-to | Carrossel 4 | `w4-hs-*` | [semana-4/](../instagram/output/programa-4-semanas/semana-4/) |
| P12 | 03/08 | 4 | L4 Feature | Card | `w4-spot-preflop` | [semana-4/w4-p12-spot-preflop.png](../instagram/output/programa-4-semanas/semana-4/w4-p12-spot-preflop.png) |
| P13 | 05/08 | 4 | L5 CTA | Card | `meet-cta` | [semana-3/w3-p10-cta.png](../instagram/output/programa-4-semanas/semana-3/w3-p10-cta.png) |
...
### P1 · 10/07 · L1 Reveal — hero "Now live"
...
### P2 · 11/07 · L2 Module tour — CARROSSEL "Meet Aura 2.0" (5 slides)
...
### P3 · 13/07 · L4 Feature — Hotspot spotlight
...
### P4 · 15/07 · L4 Feature — Postflop spotlight
...
### P5 · 17/07 · L2 — CARROSSEL "Preflop in 60s" (4 slides)
...
### P6 · 20/07 · L3 Pergunta — "Quanto o BB realmente defende?"
...
### P7 · 22/07 · L4 Feature/filtro — Estágio de torneio
...
### P8 · 24/07 · L2 — CARROSSEL "Postflop — read the pool" (4 slides)
...
### P9 · 27/07 · L3 Pergunta — "Seu pool abre demais o CO?"
...
### P10 · 29/07 · L5 CTA — "Study the field. Free."
...
### P11 · 31/07 · L2 How-to — CARROSSEL "From leak to line" (4 slides)
...
### P12 · 03/08 · L4 Feature — Preflop grid
...
### P13 · 05/08 · L5 CTA — reforço grátis (fim do mês)
