/* Gera os 3 videos de anuncio da campanha AURA-PAID01 (EN). v2. Derivado do build-paid.mjs (mesma logica de ritmo/Ken Burns).
 *
 *   node instagram/build-paid-en.mjs            # renderiza as 18 cenas + encoda os 3 MP4
 *   node instagram/build-paid-en.mjs --guides   # so renderiza, com as zonas seguras desenhadas
 *
